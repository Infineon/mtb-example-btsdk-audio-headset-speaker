...
This app demonstrates the use of a Bluetooth Headset via the WICED audio libraries. This app also supports the AAC codec for some BT devices.
...
- SPEAKER
    - This option allows the device to enable output on an audio shield board to drive the external speaker on an EVK board if it is supported. By default the option is off. This option is not applicable for the 43012C0 device.

- AAC\_SUPPORT
    - This option allows the device to enable the AAC codec if the BT chip supports. By default the 20721B2 is enables this option and the 43012C0 disables it.

## Button Functions
- On CYW920721B2EVK-02(4 buttons)<br/>
...
4. USER: Transport detect/ -/ Voice recognition<br/>
<br/>
- On CYW920721M2EVK01/02(3 buttons)<br/>
Button event: click/ long press/ hold<br/>
1. Custom: Play, Pause, Accept/ Reject, Discoverable/ -<br/>
...
## Testing with PTS
1. While testing with PTS for certification test cases, please define ENABLE_PTS_TESTING flag in makefile as shown below.
   CY_APP_DEFINES += -DENABLE_PTS_TESTING
